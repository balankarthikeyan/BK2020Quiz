...
function Tab(props) {
  ...
  var renderTabContent = function renderTabContent(item, index) {
    var name = item.name;
    var children = renderTabItemContent !== undefined ? renderTabItemContent(item, index) : react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      __source: {
        fileName: _jsxFileName,
        lineNumber: 59
      },
    ...
    var contentClassName = 'tab-menu-content overflow-scroll' + (activeTabIdx === index ? ' active' : '');
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, {
      ...
      className: "".concat(contentClassName, " ").concat(name),
      __source: {
        fileName: _jsxFileName,
        lineNumber: 67
      },
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("section", {
    ...
    __self: this
  }, list && list.map(tabItemRenderProp)), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("section", {
    className: "base-tab-content-panel",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 81
    },
...
//# sourceMappingURL=quiz.js.b671e4780e6b67c6ae8a.hot-update.js.map