...
function QuizList(props) {
  ...
  var _ref2 = props || {},
      setCount = _ref2.setCount;

  var onToggle = function onToggle() {
    var obj = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    if (obj) {
      list[obj.questionNumber].choosed = obj.index; // setCount(obj.questionNumber)
    }
...
function Quiz() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(Main, {
    ...
    __self: this
  }, "About Page ", count), react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(QuizList, {
    state: {
      setCount: setCount,
      count: count
    },
...
//# sourceMappingURL=quiz.js.d0977dca5e56f18b67f2.hot-update.js.map