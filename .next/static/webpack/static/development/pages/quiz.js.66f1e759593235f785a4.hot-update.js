...
function QuizTemplate() {
  ...
  })(["padding:10px 20px;background:black;color:white;text-transform:uppercase;font-size:1vw;border:none;margin:5px;&.buttonActive{background:red;color:white;}"]);
...
function QuizList() {
  ...
  return list.length > 0 ? list.map(function (item, index) {
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(QuizTemplate, {
...
//# sourceMappingURL=quiz.js.66f1e759593235f785a4.hot-update.js.map