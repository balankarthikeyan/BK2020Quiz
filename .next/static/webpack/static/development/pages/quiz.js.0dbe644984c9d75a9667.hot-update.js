...
function QuizTemplate() {
  ...
  })(["padding:10px 20px;background:black;color:white;text-transform:uppercase;font-size:1vw;border:none;margin:5px;&.active{background:red;color:white;}"]);

  var _React$useState = react__WEBPACK_IMPORTED_MODULE_3___default.a.useState(false),
      _React$useState2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_React$useState, 2),
      buttonActive = _React$useState2[0],
      setButtonActive = _React$useState2[1];
...
function QuizList() {
  ...
  return list.length > 0 ? list.map(function (item, index) {
    return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(QuizTemplate, {
...
//# sourceMappingURL=quiz.js.0dbe644984c9d75a9667.hot-update.js.map